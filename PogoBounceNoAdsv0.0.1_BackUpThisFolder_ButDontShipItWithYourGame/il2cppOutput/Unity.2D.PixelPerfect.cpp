...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR int32_t PixelPerfectCamera_get_pixelRatio_mD04D1FBE58D9266C9CB354DDC8911CDD69C2263F (PixelPerfectCamera_t7B0849F4AB5E6399719BE7C3B330BCBBA3AAF7A9* __this, const RuntimeMethod* method) 
{
	...
	{
		// if (m_UpscaleRT)
		bool L_2 = __this->___m_UpscaleRT_7;
		V_1 = L_2;
		bool L_3 = V_1;
		if (!L_3)
		{
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PixelPerfectCamera_PixelSnap_m260BC623D3DB1F4687F20AC085C68B4D930ABB21 (PixelPerfectCamera_t7B0849F4AB5E6399719BE7C3B330BCBBA3AAF7A9* __this, const RuntimeMethod* method) 
{
	...
	memset((&V_3), 0, sizeof(V_3));
	{
		...
		Camera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184* L_15 = __this->___m_Camera_12;
		Matrix4x4_tDB70CF134A14BA38190C59AA700BCE10E2AED3E6 L_16 = V_3;
		Camera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184* L_17 = __this->___m_Camera_12;
		NullCheck(L_17);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PixelPerfectCamera_OnPreCull_mA9E75392FDDD3D52271F8C75F7A50278E85B4037 (PixelPerfectCamera_t7B0849F4AB5E6399719BE7C3B330BCBBA3AAF7A9* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		PixelPerfectCameraInternal_t3A785975106C548143FC2C057233A72DC250FEFE* L_6 = __this->___m_Internal_13;
		NullCheck(L_6);
		Rect_tA04E0F8A1830E767F40FB27ECD8D309303571F0D L_7 = L_6->___pixelRect_11;
		NullCheck(L_5);
...
IL_003a:
	{
		...
		Rect__ctor_m18C3033D135097BEE424AAA68D91C706D2647F23((&L_9), (0.0f), (0.0f), (1.0f), (1.0f), /*hidden argument*/NULL);
		NullCheck(L_8);
...
IL_005f:
	{
		// if (!m_CinemachineCompatibilityMode)
		bool L_10 = __this->___m_CinemachineCompatibilityMode_14;
	...
	}
	{
		...
		Camera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184* L_12 = __this->___m_Camera_12;
		PixelPerfectCameraInternal_t3A785975106C548143FC2C057233A72DC250FEFE* L_13 = __this->___m_Internal_13;
		NullCheck(L_13);
		float L_14 = L_13->___orthoSize_12;
		NullCheck(L_12);
...
IL_001d:
	{
		...
		PixelPerfectCameraInternal_t3A785975106C548143FC2C057233A72DC250FEFE* L_4 = __this->___m_Internal_13;
		NullCheck(L_4);
		float L_5 = L_4->___unitsPerPixel_13;
...
IL_0020:
	...
	}
	{
		...
		PixelPerfectCameraInternal_t3A785975106C548143FC2C057233A72DC250FEFE* L_9 = __this->___m_Internal_13;
		NullCheck(L_9);
		bool L_10 = L_9->___useStretchFill_6;
		G_B4_0 = L_8;
		if (L_10)
		{
			G_B5_0 = L_8;
...
IL_004f:
	{
		...
		PixelPerfectCameraInternal_t3A785975106C548143FC2C057233A72DC250FEFE* L_12 = __this->___m_Internal_13;
...
{
	{
		...
		__this->___m_UpscaleRT_7 = (bool)0;
		// bool m_PixelSnapping = false;
		__this->___m_PixelSnapping_8 = (bool)0;
		// bool m_CropFrameX = false;
		__this->___m_CropFrameX_9 = (bool)0;
		// bool m_CropFrameY = false;
		__this->___m_CropFrameY_10 = (bool)0;
		// bool m_StretchFill = false;
		__this->___m_StretchFill_11 = (bool)0;
		MonoBehaviour__ctor_m592DB0105CA0BC97AA1C5F4AD27B12D68A3B7C1E(__this, NULL);
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PixelPerfectCameraInternal_OnAfterDeserialize_mDACB77CE1C48E71D52E67812D687FAC6D900C259 (PixelPerfectCameraInternal_t3A785975106C548143FC2C057233A72DC250FEFE* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		PixelPerfectCamera_t7B0849F4AB5E6399719BE7C3B330BCBBA3AAF7A9* L_3 = __this->___m_SerializableComponent_1;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PixelPerfectCameraInternal_CalculateCameraProperties_m0C1A9F48317FBD0710DCEF29FB7D4B7ECEADE4F7 (PixelPerfectCameraInternal_t3A785975106C548143FC2C057233A72DC250FEFE* __this, int32_t ___0_screenWidth, int32_t ___1_screenHeight, const RuntimeMethod* method) 
{
	...
	{
		// if (useStretchFill)
		bool L_34 = __this->___useStretchFill_6;
		V_12 = L_34;
		bool L_35 = V_12;
		if (!L_35)
		{
...
IL_010d:
	{
		...
		__this->___useOffscreenRT_8 = (bool)1;
		// if (cropFrameXAndY)
		bool L_40 = __this->___cropFrameXAndY_4;
		V_13 = L_40;
		bool L_41 = V_13;
		if (!L_41)
		{
...
IL_0133:
	...
	}
	{
		...
		int32_t L_47 = __this->___zoom_7;
		__this->___offscreenRTWidth_9 = ((int32_t)il2cpp_codegen_multiply(((int32_t)(((int32_t)(L_46/L_47))/2)), 2));
		// offscreenRTHeight = refResolutionY;
		int32_t L_48 = V_2;
		__this->___offscreenRTHeight_10 = L_48;
		goto IL_0173;
	}
...
IL_0158:
	{
		// offscreenRTWidth = refResolutionX;
		int32_t L_49 = V_1;
		__this->___offscreenRTWidth_9 = L_49;
		// offscreenRTHeight = screenHeight / zoom / 2 * 2;   // Make sure it's an even number by / 2 * 2.
		int32_t L_50 = ___1_screenHeight;
		int32_t L_51 = __this->___zoom_7;
		__this->___offscreenRTHeight_10 = ((int32_t)il2cpp_codegen_multiply(((int32_t)(((int32_t)(L_50/L_51))/2)), 2));
	}
...
IL_0186:
	...
	}
	{
		...
		int32_t L_56 = __this->___zoom_7;
		__this->___offscreenRTWidth_9 = ((int32_t)il2cpp_codegen_multiply(((int32_t)(((int32_t)(L_55/L_56))/2)), 2));
		// offscreenRTHeight = screenHeight / zoom / 2 * 2;
		int32_t L_57 = ___1_screenHeight;
		int32_t L_58 = __this->___zoom_7;
		__this->___offscreenRTHeight_10 = ((int32_t)il2cpp_codegen_multiply(((int32_t)(((int32_t)(L_57/L_58))/2)), 2));
	}
...
IL_01b9:
	{
		...
		__this->___pixelRect_11 = L_59;
		// if (cropFrameXOrY && !upscaleRT && !useStretchFill)
		bool L_60 = __this->___cropFrameXOrY_5;
		if (!L_60)
		{
			goto IL_01da;
		}
	...
	{
		bool L_62 = __this->___useStretchFill_6;
...
IL_01db:
	...
	{
		// if (cropFrameXAndY)
		bool L_64 = __this->___cropFrameXAndY_4;
		V_17 = L_64;
		bool L_65 = V_17;
		if (!L_65)
		{
	...
	}
	{
		...
		Rect_tA04E0F8A1830E767F40FB27ECD8D309303571F0D* L_66 = (&__this->___pixelRect_11);
		int32_t L_67 = __this->___zoom_7;
		int32_t L_68 = V_1;
		Rect_set_width_m93B6217CF3EFF89F9B0C81F34D7345DE90B93E5A(L_66, ((float)((int32_t)il2cpp_codegen_multiply(L_67, L_68))), NULL);
		// pixelRect.height = zoom * refResolutionY;
		Rect_tA04E0F8A1830E767F40FB27ECD8D309303571F0D* L_69 = (&__this->___pixelRect_11);
		int32_t L_70 = __this->___zoom_7;
		int32_t L_71 = V_2;
		Rect_set_height_mD00038E6E06637137A5626CA8CD421924005BF03(L_69, ((float)((int32_t)il2cpp_codegen_multiply(L_70, L_71))), NULL);
		goto IL_0273;
	}
...
IL_021f:
	...
	}
	{
		...
		Rect_set_width_m93B6217CF3EFF89F9B0C81F34D7345DE90B93E5A(L_74, ((float)L_75), NULL);
		// pixelRect.height = zoom * refResolutionY;
		Rect_tA04E0F8A1830E767F40FB27ECD8D309303571F0D* L_76 = (&__this->___pixelRect_11);
		int32_t L_77 = __this->___zoom_7;
		int32_t L_78 = V_2;
		Rect_set_height_mD00038E6E06637137A5626CA8CD421924005BF03(L_76, ((float)((int32_t)il2cpp_codegen_multiply(L_77, L_78))), NULL);
		goto IL_0273;
	}
...
IL_024e:
	{
		...
		int32_t L_80 = __this->___zoom_7;
		int32_t L_81 = V_1;
		Rect_set_width_m93B6217CF3EFF89F9B0C81F34D7345DE90B93E5A(L_79, ((float)((int32_t)il2cpp_codegen_multiply(L_80, L_81))), NULL);
		...
		Rect_set_height_mD00038E6E06637137A5626CA8CD421924005BF03(L_82, ((float)L_83), NULL);
	}
...
IL_0273:
	{
		...
		Rect_tA04E0F8A1830E767F40FB27ECD8D309303571F0D* L_86 = (&__this->___pixelRect_11);
		float L_87;
		L_87 = Rect_get_width_m620D67551372073C9C32C4C4624C2A5713F7F9A9(L_86, NULL);
		Rect_set_x_mAB91AB71898A20762BC66FD0723C4C739C4C3406(L_84, ((float)((int32_t)(((int32_t)il2cpp_codegen_subtract(L_85, il2cpp_codegen_cast_double_to_int<int32_t>(L_87)))/2))), NULL);
		...
		Rect_tA04E0F8A1830E767F40FB27ECD8D309303571F0D* L_90 = (&__this->___pixelRect_11);
		float L_91;
		L_91 = Rect_get_height_mE1AA6C6C725CCD2D317BD2157396D3CF7D47C9D8(L_90, NULL);
		Rect_set_y_mDE91F4B98A6E8623EFB1250FF6526D5DB5855629(L_88, ((float)((int32_t)(((int32_t)il2cpp_codegen_subtract(L_89, il2cpp_codegen_cast_double_to_int<int32_t>(L_91)))/2))), NULL);
		goto IL_02e1;
	}
...
IL_02b0:
	{
		...
		bool L_92 = __this->___useOffscreenRT_8;
		V_19 = L_92;
		bool L_93 = V_19;
		if (!L_93)
		{
	...
	}
	{
		...
		int32_t L_94 = __this->___offscreenRTWidth_9;
		int32_t L_95 = __this->___offscreenRTHeight_10;
		Rect_tA04E0F8A1830E767F40FB27ECD8D309303571F0D L_96;
		memset((&L_96), 0, sizeof(L_96));
		Rect__ctor_m18C3033D135097BEE424AAA68D91C706D2647F23((&L_96), (0.0f), (0.0f), ((float)L_94), ((float)L_95), /*hidden argument*/NULL);
		__this->___pixelRect_11 = L_96;
	}
...
IL_02e1:
	...
	}
	{
		...
		int32_t L_99 = V_2;
		int32_t L_100 = V_0;
		__this->___orthoSize_12 = ((float)(((float)il2cpp_codegen_multiply(((float)L_99), (0.5f)))/((float)L_100)));
		goto IL_03bb;
	}
...
IL_02ff:
	...
	}
	{
		...
		Rect_tA04E0F8A1830E767F40FB27ECD8D309303571F0D L_103 = __this->___pixelRect_11;
		Rect_tA04E0F8A1830E767F40FB27ECD8D309303571F0D L_104;
		L_104 = Rect_get_zero_m5341D8B63DEF1F4C308A685EEC8CFEA12A396C8D(NULL);
		bool L_105;
		L_105 = Rect_op_Equality_mF2A038255CAF5F1E86079B9EE0FC96DE54307C1F(L_103, L_104, NULL);
		if (L_105)
		{
			goto IL_0333;
		}
	...
	{
		Rect_tA04E0F8A1830E767F40FB27ECD8D309303571F0D* L_106 = (&__this->___pixelRect_11);
		float L_107;
		L_107 = Rect_get_width_m620D67551372073C9C32C4C4624C2A5713F7F9A9(L_106, NULL);
		Rect_tA04E0F8A1830E767F40FB27ECD8D309303571F0D* L_108 = (&__this->___pixelRect_11);
		float L_109;
		L_109 = Rect_get_height_mE1AA6C6C725CCD2D317BD2157396D3CF7D47C9D8(L_108, NULL);
...
IL_0338:
	{
		...
		float L_113 = V_22;
		int32_t L_114 = V_0;
		__this->___orthoSize_12 = ((float)(((float)il2cpp_codegen_multiply(((float)(((float)L_112)/L_113)), (0.5f)))/((float)L_114)));
		goto IL_03bb;
	}
...
IL_0351:
	...
	{
		int32_t L_116 = __this->___zoom_7;
...
IL_0360:
	...
	}
	{
		...
		int32_t L_118 = __this->___offscreenRTHeight_10;
		int32_t L_119 = V_0;
		__this->___orthoSize_12 = ((float)(((float)il2cpp_codegen_multiply(((float)L_118), (0.5f)))/((float)L_119)));
		goto IL_03bb;
	}
...
IL_037e:
	{
		...
		Rect_tA04E0F8A1830E767F40FB27ECD8D309303571F0D L_120 = __this->___pixelRect_11;
		Rect_tA04E0F8A1830E767F40FB27ECD8D309303571F0D L_121;
		L_121 = Rect_get_zero_m5341D8B63DEF1F4C308A685EEC8CFEA12A396C8D(NULL);
		bool L_122;
		L_122 = Rect_op_Equality_mF2A038255CAF5F1E86079B9EE0FC96DE54307C1F(L_120, L_121, NULL);
		if (L_122)
		{
			goto IL_039e;
		}
	...
	{
		Rect_tA04E0F8A1830E767F40FB27ECD8D309303571F0D* L_123 = (&__this->___pixelRect_11);
		float L_124;
		L_124 = Rect_get_height_mE1AA6C6C725CCD2D317BD2157396D3CF7D47C9D8(L_123, NULL);
		G_B45_0 = L_124;
		goto IL_03a0;
	}
...
IL_03a0:
	{
		...
		float L_126 = V_24;
		int32_t L_127 = __this->___zoom_7;
		int32_t L_128 = V_0;
		__this->___orthoSize_12 = ((float)(((float)il2cpp_codegen_multiply(L_126, (0.5f)))/((float)((int32_t)il2cpp_codegen_multiply(L_127, L_128)))));
	}
...
IL_03c8:
	...
	}
	{
		...
		int32_t L_133 = V_0;
		__this->___unitsPerPixel_13 = ((float)((1.0f)/((float)L_133)));
		goto IL_03f3;
	}
...
IL_03de:
	{
		...
		int32_t L_134 = __this->___zoom_7;
		int32_t L_135 = V_0;
		__this->___unitsPerPixel_13 = ((float)((1.0f)/((float)((int32_t)il2cpp_codegen_multiply(L_134, L_135)))));
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR Rect_tA04E0F8A1830E767F40FB27ECD8D309303571F0D PixelPerfectCameraInternal_CalculatePostRenderPixelRect_mC41F2F6B554C0E28AB9344868E3B887118221B39 (PixelPerfectCameraInternal_t3A785975106C548143FC2C057233A72DC250FEFE* __this, float ___0_cameraAspect, int32_t ___1_screenWidth, int32_t ___2_screenHeight, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		Rect_set_height_mD00038E6E06637137A5626CA8CD421924005BF03((&V_0), ((float)L_7), NULL);
		// pixelRect.width = screenHeight * cameraAspect;
		int32_t L_8 = ___2_screenHeight;
		float L_9 = ___0_cameraAspect;
		Rect_set_width_m93B6217CF3EFF89F9B0C81F34D7345DE90B93E5A((&V_0), ((float)il2cpp_codegen_multiply(((float)L_8), L_9)), NULL);
		// pixelRect.x = (screenWidth - (int)pixelRect.width) / 2;
		int32_t L_10 = ___1_screenWidth;
		float L_11;
		L_11 = Rect_get_width_m620D67551372073C9C32C4C4624C2A5713F7F9A9((&V_0), NULL);
		Rect_set_x_mAB91AB71898A20762BC66FD0723C4C739C4C3406((&V_0), ((float)((int32_t)(((int32_t)il2cpp_codegen_subtract(L_10, il2cpp_codegen_cast_double_to_int<int32_t>(L_11)))/2))), NULL);
		// pixelRect.y = 0;
...
IL_0061:
	{
		...
		Rect_set_width_m93B6217CF3EFF89F9B0C81F34D7345DE90B93E5A((&V_0), ((float)L_12), NULL);
		// pixelRect.height = screenWidth / cameraAspect;
		int32_t L_13 = ___1_screenWidth;
		float L_14 = ___0_cameraAspect;
		Rect_set_height_mD00038E6E06637137A5626CA8CD421924005BF03((&V_0), ((float)(((float)L_13)/L_14)), NULL);
		// pixelRect.y = (screenHeight - (int)pixelRect.height) / 2;
		int32_t L_15 = ___2_screenHeight;
		float L_16;
		L_16 = Rect_get_height_mE1AA6C6C725CCD2D317BD2157396D3CF7D47C9D8((&V_0), NULL);
		Rect_set_y_mDE91F4B98A6E8623EFB1250FF6526D5DB5855629((&V_0), ((float)((int32_t)(((int32_t)il2cpp_codegen_subtract(L_15, il2cpp_codegen_cast_double_to_int<int32_t>(L_16)))/2))), NULL);
		// pixelRect.x = 0;
...
IL_009e:
	{
		...
		int32_t L_17 = __this->___zoom_7;
		int32_t L_18 = __this->___offscreenRTHeight_10;
		Rect_set_height_mD00038E6E06637137A5626CA8CD421924005BF03((&V_0), ((float)((int32_t)il2cpp_codegen_multiply(L_17, L_18))), NULL);
		// pixelRect.width = zoom * offscreenRTWidth;
		int32_t L_19 = __this->___zoom_7;
		int32_t L_20 = __this->___offscreenRTWidth_9;
		Rect_set_width_m93B6217CF3EFF89F9B0C81F34D7345DE90B93E5A((&V_0), ((float)((int32_t)il2cpp_codegen_multiply(L_19, L_20))), NULL);
		// pixelRect.x = (screenWidth - (int)pixelRect.width) / 2;
		int32_t L_21 = ___1_screenWidth;
		float L_22;
		L_22 = Rect_get_width_m620D67551372073C9C32C4C4624C2A5713F7F9A9((&V_0), NULL);
		Rect_set_x_mAB91AB71898A20762BC66FD0723C4C739C4C3406((&V_0), ((float)((int32_t)(((int32_t)il2cpp_codegen_subtract(L_21, il2cpp_codegen_cast_double_to_int<int32_t>(L_22)))/2))), NULL);
		// pixelRect.y = (screenHeight - (int)pixelRect.height) / 2;
		int32_t L_23 = ___2_screenHeight;
		float L_24;
		L_24 = Rect_get_height_mE1AA6C6C725CCD2D317BD2157396D3CF7D47C9D8((&V_0), NULL);
		Rect_set_y_mDE91F4B98A6E8623EFB1250FF6526D5DB5855629((&V_0), ((float)((int32_t)(((int32_t)il2cpp_codegen_subtract(L_23, il2cpp_codegen_cast_double_to_int<int32_t>(L_24)))/2))), NULL);
	}
...
IL_0076:
	{
		...
		NullCheck(L_17);
		bool L_18;
		L_18 = InterfaceFuncInvoker0< bool >::Invoke(6 /* System.Boolean UnityEngine.U2D.IPixelPerfectCamera::get_upscaleRT() */, IPixelPerfectCamera_tB4C3F4D97915BC1D1D31D68788C8F4290B94A987_il2cpp_TypeInfo_var, L_17);
		if (L_18)
		{
			goto IL_0093;
		}
	}
	{
		...
		NullCheck(L_19);
		bool L_20;
		L_20 = InterfaceFuncInvoker0< bool >::Invoke(8 /* System.Boolean UnityEngine.U2D.IPixelPerfectCamera::get_pixelSnapping() */, IPixelPerfectCamera_tB4C3F4D97915BC1D1D31D68788C8F4290B94A987_il2cpp_TypeInfo_var, L_19);
...
IL_0094:
	...
	}
	{
		...
		NullCheck(L_23);
		int32_t L_24;
		L_24 = InterfaceFuncInvoker0< int32_t >::Invoke(0 /* System.Int32 UnityEngine.U2D.IPixelPerfectCamera::get_assetsPPU() */, IPixelPerfectCamera_tB4C3F4D97915BC1D1D31D68788C8F4290B94A987_il2cpp_TypeInfo_var, L_23);
